  ...
  <body>
   ...
   <div class="navbar  navbar-fixed-top">
    ...
    <div class="container">     
        <!-- FOOTER -->
        <section>
            <p class="text-center muted">&copy; Copyright 2014 - <?php echo $this->config->item('nama_instansi');?><br>Created By : <a href="http://thewins.web.id" target="_blank">FASTWEBINDO</a><br>Page rendered in <strong>{elapsed_time}</strong> seconds</p>
        </section>
    </div> <!-- end container -->
